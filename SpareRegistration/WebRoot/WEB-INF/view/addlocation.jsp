	...
	<form method="post" action="">
		<table width="900" cellpadding="2" cellspacing="0">
			...
			<tr>
				<td>Байр:</td>
				<td>
					<input type="text" id="c_building" name="c_building" style="width: 500px;" />
				</td>
			</tr>
			<tr>
				<td>Өрөө:</td>
				<td>
					<input type="text" id="c_room" name="c_room" style="width: 500px;" />
				</td>
			</tr>
			<tr>
				<td>Шүүгээ:</td>
				<td>
					<input type="text" id="c_rack" name="c_rack" style="width: 500px;" />
				</td>
			</tr>
